...
#ifndef __ProxyStyle_h
#define __ProxyStyle_h
...
class ProxyStyle : public QProxyStyle
{
	Q_OBJECT
public:
	ProxyStyle(QStyle* baseStyle = nullptr, QObject* parent = nullptr);
	~ProxyStyle() override;

	// Ensure a valid base style is set (e.g., QApplication::style()) before use.
	void ensureBaseStyle() const;

	// Drawing/metrics overrides
