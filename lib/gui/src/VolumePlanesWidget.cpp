...
VolumePlanesWidget::VolumePlanesWidget(QWidget* parent)
	: QWidget(parent)
{
	ui.setupUi(this);
	...
	// connect UI
	connect(ui.croppingCheckBox, &QCheckBox::toggled, this, &VolumePlanesWidget::setSiblingControlsEnabled);
	connect(ui.resetButton, &QPushButton::clicked, this, &VolumePlanesWidget::on_resetButton_clicked);

	// RangeSlider provides valuesChanged(min,max)
	connect(ui.xRangeSlider, &RangeSlider::valuesChanged, this, &VolumePlanesWidget::on_xRangeSlider_valuesChanged);
	connect(ui.yRangeSlider, &RangeSlider::valuesChanged, this, &VolumePlanesWidget::on_yRangeSlider_valuesChanged);
	connect(ui.zRangeSlider, &RangeSlider::valuesChanged, this, &VolumePlanesWidget::on_zRangeSlider_valuesChanged);

	// sensible defaults for labels (in case caller doesn't call setRangeSliders)
	setRangeSliders(0, 1000, 0, 1000, 0, 1000);
}

VolumePlanesWidget::~VolumePlanesWidget() = default;

void VolumePlanesWidget::setRangeSliders(int xMin, int xMax, int yMin, int yMax, int zMin, int zMax)
{
...
void VolumePlanesWidget::onExternalCroppingChanged(bool enabled)
{
	if (ui.croppingCheckBox->isChecked() != enabled)
	{
...
void VolumePlanesWidget::on_resetButton_clicked()
{
...
void VolumePlanesWidget::on_xRangeSlider_valuesChanged(int min, int max)
{
...
void VolumePlanesWidget::on_yRangeSlider_valuesChanged(int min, int max)
{
...
void VolumePlanesWidget::on_zRangeSlider_valuesChanged(int min, int max)
{
...
void VolumePlanesWidget::setSiblingControlsEnabled(bool on)
{
...
void VolumePlanesWidget::updateLabels()
{
